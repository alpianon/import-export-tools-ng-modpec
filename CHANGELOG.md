# ImportExportTools NG modPEC Changelog

## Versions

4.0.4-b1 - November 30, 2019
- ported modPEC for old ImportExportTools to ImportExportTools NG
- everything seems to work, but it needs some more testing

## Original NG Extension
