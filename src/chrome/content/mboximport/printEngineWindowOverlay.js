...
var IETprintPDFengine = {
	...
	restore: function () {
		IETprintPDFengine.prefs.setBoolPref("extensions.importexporttoolsngmodpec.printPDF.start", false);
		if (IETprintPDFengine.prefs.getBoolPref("extensions.importexporttoolsngmodpec.printPDF.restore_print_silent"))
	...
	onLoad: function () {
		try {
			...
			var fileFormat = IETprintPDFengine.prefs.getIntPref("extensions.importexporttoolsngmodpec.printPDF.fileFormat");
			if (fileFormat < 3)
...
if (IETprintPDFengine.prefs.getBoolPref("extensions.importexporttoolsngmodpec.printPDF.start")) {
