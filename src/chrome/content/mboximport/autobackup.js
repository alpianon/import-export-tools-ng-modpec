...
var autoBackup = {
	...
	onOK: function () {
		...
		autoBackup.saveMode = gBackupPrefBranch.getIntPref("extensions.importexporttoolsngmodpec.autobackup.save_mode");
		autoBackup.type = gBackupPrefBranch.getIntPref("extensions.importexporttoolsngmodpec.autobackup.type");
		// return false;
	},
	...
	getDir: function () {
		...
		try {
			var dir = gBackupPrefBranch.getCharPref("extensions.importexporttoolsngmodpec.autobackup.dir");
	...
	start: function () {
		...
		var nameType = gBackupPrefBranch.getIntPref("extensions.importexporttoolsngmodpec.autobackup.dir_name_type");

		var dirName = null;
		if (nameType === 1) {
			try {
				dirName = gBackupPrefBranch.getCharPref("extensions.importexporttoolsngmodpec.autobackup.dir_custom_name");
			} catch (e) {
				dirName = null;
			}
		}
	...
	write: function (index) {
		...
		if (autoBackup.array1.length > index) {
			...
			gBackupPrefBranch.setIntPref("extensions.importexporttoolsngmodpec.autobackup.last", autoBackup.time);
